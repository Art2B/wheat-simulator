...
const fieldArrayValidator = {
    set (obj, prop, value) {
        ...
        if (value.type === "plant") obj[prop] = new Proxy(value, plantElementProxy);
        else obj[prop] = value;
...
class Actions {
    ...
    static harvest(ressource) {
        ...
        const toHarvest = proxiedFields.filter((item)=>item.ready && item.ressource === ressource);
        toHarvest.forEach((item)=>{
            proxiedFields.splice(proxiedFields.findIndex((i)=>i.id === item.id), 1);
    ...
    static craft(ressource) {
        ...
        for (const [r, quantity] of Object.entries(ingredients))proxiedInventory[r] -= quantity;
...
const handleButtonClick = (event)=>{
    ...
    if (action) {
        ...
        if (typeof actionMethod === "function") actionMethod.call(Actions, event.target?.dataset.ressource);
    }
};
...
},{"./max.js":false,"./nil.js":false,"./parse.js":false,"./stringify.js":false,"./v1.js":false,"./v1ToV6.js":false,"./v3.js":false,"./v4.js":"7Sd5x","./v5.js":false,"./v6.js":false,"./v6ToV1.js":false,"./v7.js":false,"./validate.js":false,"./version.js":false,"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9dsAN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"7Sd5x":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aMz2Q":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["eZFTg","9Fk10"], "9Fk10", "parcelRequire8661", {})

//# sourceMappingURL=wheat-simulator.c9112ede.js.map
